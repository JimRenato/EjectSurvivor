...
public class Scenario extends JFrame implements KeyListener {
	...
	private Icon spaceI = new ImageIcon("src/main/resources/images/space.gif");
	private Icon space1I = new ImageIcon("src/main/resources/images/space1.gif");
	private Icon titleI = new ImageIcon("src/main/resources/images/title.png");
	private Icon autorI = new ImageIcon("src/main/resources/images/autor.png");
	private Icon pressEnterI = new ImageIcon("src/main/resources/images/pressEnters.gif");
	private Icon naveI = new ImageIcon("src/main/resources/images/nave.png");
	private Icon helloI = new ImageIcon("src/main/resources/images/hello.gif");
	private Icon etI = new ImageIcon("src/main/resources/images/et.gif");
	private Icon ciclopsI = new ImageIcon("src/main/resources/images/ciclops.gif");
	private Icon robotI = new ImageIcon("src/main/resources/images/robot.gif");
	private Icon fireI = new ImageIcon("src/main/resources/images/fire.gif");
	private Icon gas0I = new ImageIcon("src/main/resources/images/gas0.gif");
	private Icon gas1I = new ImageIcon("src/main/resources/images/gas1.gif");
	private Icon numberR1I = new ImageIcon("src/main/resources/images/numberR1.png");
	private Icon numberR2I = new ImageIcon("src/main/resources/images/numberR2.png");
	private Icon numberR3I = new ImageIcon("src/main/resources/images/numberR3.png");
